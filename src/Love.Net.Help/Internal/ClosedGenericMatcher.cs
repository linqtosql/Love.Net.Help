...
namespace Love.Net.Help {
    ...
    internal static class ClosedGenericMatcher {
        ...
        private static bool IsGenericInstantiation(Type candidate, Type interfaceType) => candidate.GetTypeInfo().IsGenericType && candidate.GetGenericTypeDefinition() == interfaceType;
